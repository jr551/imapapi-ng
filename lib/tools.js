 ...
 */
function setBit(buffer, bytePos, bit, value) {
 ...
 */
function readBit(buffer, bytePos, bit) {
 ...
 */
function compareExisting(storedMessageEntry, messageData, keys) {
    const changes = {};
...
async function resolveCredentials(account, proto) {
